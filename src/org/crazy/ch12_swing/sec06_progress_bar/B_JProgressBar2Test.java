...
public class B_JProgressBar2Test {
    JFrame frame = new JFrame("进度条测试2");
    // 创建一个垂直进度条
    ...
    public static void main(String[] args) {
        new B_JProgressBar2Test().init();
    }
}

// 模拟一个耗时的任务
class B_SimulatedActivity implements Runnable {
    // 任务的当前完成量
    private volatile int current;
    // 总任务量
    private int amount;

    public B_SimulatedActivity(int amount) {
        current = 0;
        this.amount = amount;
    }
