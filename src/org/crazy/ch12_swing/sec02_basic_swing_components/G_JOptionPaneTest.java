...
public class G_JOptionPaneTest {
    JFrame jf = new JFrame("JOptionPane测试");
    // 定义6个面板，分别用于定义对话框的几种选项
    private G_ButtonPanel messagePanel;
    private G_ButtonPanel messageTypePanel;
    private G_ButtonPanel msgPanel;
    private G_ButtonPanel confirmPanel;
    private G_ButtonPanel optionsPanel;
    private G_ButtonPanel inputPanel;
    private String messageString = "消息区内容";
    private Icon messageIcon = new ImageIcon("../data/ch12_swing/ico/heart.png");
    ...
    public void init() {
        ...
        messageTypePanel = new G_ButtonPanel("选择消息的类型",
                new String[] {"ERROR_MESSAGE", "INFORMATION_MESSAGE",
                "WARNING_MESSAGE", "QUESTION_MESSAGE", "PLAIN_MESSAGE"});
        // 消息内容类型Panel，该Panel中的选项的后果消息区的内容
        messagePanel = new G_ButtonPanel("选择消息内容的类型",
        ...
        // 创建用于弹出消息对话框的Panel
        msgPanel = new G_ButtonPanel("消息对话框", null);
        msgBn.addActionListener(new ShowAction());
        msgPanel.add(msgBn);

        // 创建用于弹出确认对话框的Panel
        confirmPanel = new G_ButtonPanel("确认对话框",
        ...
        // 创建用于弹出输入对话框的Panel
        inputPanel = new G_ButtonPanel("输入对话框",
                new String[] {"单行文本框", "下拉列表框"});
        inputBn.addActionListener(new ShowAction());
        inputPanel.add(inputBn);

        // 创建用于弹出选项对话框的Panel
        optionsPanel = new G_ButtonPanel("选项对话框",
    ...
    private Object[] getOptions() {
        switch (optionsPanel.getSelection()) {
            ...
            case "图标选项":
                return new Icon[] {new ImageIcon("../data/ch12_swing/ico/1.gif"),
                    new ImageIcon("../data/ch12_swing/ico/2.gif"),
                    new ImageIcon("../data/ch12_swing/ico/3.gif"),
                    new ImageIcon("../data/ch12_swing/ico/4.gif")};
            default:
...
class G_ButtonPanel extends JPanel {
    private ButtonGroup group;
    public G_ButtonPanel(String title, String[] options) {
