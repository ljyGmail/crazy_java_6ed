...
public class A_SwingComponentTest {
    ...
    // 创建"新建"菜单项，并为之指定图标
    Icon newIcon = new ImageIcon("../data/ch12_swing/ico/new.png");
    JMenuItem newItem = new JMenuItem("新建", newIcon);
    // 创建"保存"菜单项，并为之指定图标
    Icon saveIcon = new ImageIcon("../data/ch12_swing/ico/save.png");
    JMenuItem saveItem = new JMenuItem("保存", saveIcon);
    // 创建"退出"菜单项，并为之指定图标
    Icon exitIcon = new ImageIcon("../data/ch12_swing/ico/exit.png");
    ...
    JMenuItem copyItem = new JMenuItem("复制",
            new ImageIcon("../data/ch12_swing/ico/copy.png"));
    // 创建"粘贴"菜单项，并为之指定图标
    JMenuItem pasteItem = new JMenuItem("粘贴",
            new ImageIcon("../data/ch12_swing/ico/paste.png"));
