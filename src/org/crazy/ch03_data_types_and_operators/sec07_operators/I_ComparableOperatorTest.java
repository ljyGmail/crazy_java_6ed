...
public class I_ComparableOperatorTest {
    public static void main(String[] args) {
        ...
        // 创建两个ComparableOperatorTest对象，分别赋给t1和t2两个引用
        var t1 = new I_ComparableOperatorTest();
        var t2 = new I_ComparableOperatorTest();
        // t1和t2是同一个类型的两个实例的引用，所以可以比较
