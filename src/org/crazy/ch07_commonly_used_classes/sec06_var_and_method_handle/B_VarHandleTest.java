...
public class B_VarHandleTest {
    public static void main(String[] args) throws Throwable {
        ...
        // 类型为String的实例变量
        var vh1 = MethodHandles.lookup().findVarHandle(B_User.class,
                "name", String.class);
        var user = new B_User();
        ...
        vh1.set(user, "孙悟空");
        // 输出user的name实例变量的值
        System.out.println(user.name); // 输出"孙悟空"

        // 用findVarHandle方法获取User类中名为MAX_AGE
        // 类型为int的类变量
        var vh2 = MethodHandles.lookup().findStaticVarHandle(B_User.class,
                "MAX_AGE", int.class);
        ...
        vh2.set(100);
        // 输出User的MAX_AGE类变量
        System.out.println(B_User.MAX_AGE); // 输出100
    }
}
